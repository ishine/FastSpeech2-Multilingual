...
if __name__ == "__main__":
    ...
    preprocess_config = yaml.load(open("./config/LibriTTS/preprocess.yaml"), Loader=yaml.FullLoader)
    train_config = yaml.load(open("./config/LibriTTS/train.yaml"), Loader=yaml.FullLoader)
    model_config = yaml.load(open("./config/LibriTTS/model.yaml"), Loader=yaml.FullLoader)
